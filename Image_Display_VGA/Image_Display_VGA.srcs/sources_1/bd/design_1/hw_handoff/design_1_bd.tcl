...
connect_bd_intf_net -intf_net [get_bd_intf_nets v_tpg_0_m_axis_video] [get_bd_intf_pins ila_2/SLOT_0_AXIS] [get_bd_intf_pins v_tpg_0/m_axis_video]

  # Create port connections
  connect_bd_net -net B_Dout [get_bd_ports VGA_B] [get_bd_pins B/Dout] [get_bd_pins ila_1/probe0]
  connect_bd_net -net G_Dout [get_bd_ports VGA_G] [get_bd_pins G/Dout] [get_bd_pins ila_1/probe2]
  connect_bd_net -net R_Dout [get_bd_ports VGA_R] [get_bd_pins R/Dout] [get_bd_pins ila_1/probe1]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins ila_0/clk] [get_bd_pins ila_1/clk] [get_bd_pins ila_2/clk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins v_axi4s_vid_out_0/aclk] [get_bd_pins v_tc_0/clk] [get_bd_pins v_tpg_0/ap_clk]
  ...
  connect_bd_net -net v_axi4s_vid_out_0_vid_data [get_bd_pins B/Din] [get_bd_pins G/Din] [get_bd_pins R/Din] [get_bd_pins v_axi4s_vid_out_0/vid_data]
  connect_bd_net -net v_axi4s_vid_out_0_vid_hsync [get_bd_ports VGA_HS] [get_bd_pins ila_0/probe0] [get_bd_pins v_axi4s_vid_out_0/vid_hsync]
  connect_bd_net -net v_axi4s_vid_out_0_vid_vsync [get_bd_ports VGA_VS] [get_bd_pins ila_0/probe1] [get_bd_pins v_axi4s_vid_out_0/vid_vsync]
  connect_bd_net -net v_axi4s_vid_out_0_vtg_ce [get_bd_pins ila_0/probe2] [get_bd_pins v_axi4s_vid_out_0/vtg_ce] [get_bd_pins v_tc_0/gen_clken]
